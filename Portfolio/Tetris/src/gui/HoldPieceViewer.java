...
/**
 * This is the panel used to view the hold piece.
 * 
...
public class HoldPieceViewer extends JPanel implements Observer {
    ...
    /**
     * Boolean flag for if a piece is being held.
     */
    private boolean myHolding;
    ...
    /**
     * Removes hold piece, used upon creation of a new game.
     */
    ...
    /**
     * Boolean toggle for whether there is a hold piece or not.
     * 
     * @param theHolding is the hold value to be set.
     */
    private void isHolding(final boolean theHolding) {
        myHolding = theHolding;
    }
